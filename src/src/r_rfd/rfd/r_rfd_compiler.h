...
/* Compiler dependent definition */
    ...
    #define R_RFD_NO_OPERATION                       NOP()
    #define R_RFD_DISABLE_INTERRUPT                  DI()
    #define R_RFD_ENABLE_INTERRUPT                   EI()
    #define R_RFD_GET_PSW_IE_STATE                   (1U)
    #define R_RFD_IS_PSW_IE_ENABLE(u08_psw_ie_state) (1U)
	#define __near
#else
    /* Unknown compiler error */
    #error  "Non-supported compiler."
