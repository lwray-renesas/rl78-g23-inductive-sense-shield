    ...
    switch (mode)
    {
        ...
        case SXCLK:
            ...
            if (1U == XTSTOP)
            {
                ...
                /* WAIT_LOOP */
                for (w_count = 0U; w_count <= BSP_SUBWAITTIME; w_count++)
                {
        ...
        case HIOCLK:
            ...
            if (1U == HIOSTOP)
            {
                ...
                /* WAIT_LOOP */
                for (w_count = 0U; w_count <= BSP_FIHWAITTIME; w_count++)
                {
                    BSP_NOP();
                }
            }
        ...
        case MIOCLK:
            ...
            if (0U == MIOEN)
            {
                ...
                /* WAIT_LOOP */
                for (w_count = 0U; w_count <= BSP_FIMWAITTIME; w_count++)
                {
                    BSP_NOP();
                }
            }
        ...
        switch (mode)
        {
            ...
            case LOCLK:
                ...
                else
                {
                    ...
                    SELLOSC = 1U;
                    /* WAIT_LOOP */
                    for (w_count = 0U; w_count <= BSP_FILWAITTIME; w_count++)
                    {
                        BSP_NOP();
                    }
                    CSS = 1U;
