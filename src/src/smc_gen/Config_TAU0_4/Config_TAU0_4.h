...
Macro definitions
***********************************************************************************************************************/
#define _0001_TAU_TDR04_VALUE                              (0x0001U)    /* 16-bit timer data register 04 */
#define _0003_TAU_TDR05_VALUE                              (0x0003U)    /* 16-bit timer data register 05 */
...
void R_Config_TAU0_4_Set_SoftwareTriggerOn(void);
